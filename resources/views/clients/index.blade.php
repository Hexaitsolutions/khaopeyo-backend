                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-sm-6 col-lg-4 my-auto">
                            <div
                                ...
                                <span class="avatar me-sm-4 my-auto">
                                    <span class="avatar-initial bg-label-secondary rounded"><img
                                            src="assets/svg/icons/Drivers.svg" class="sidebar-svg-icon"
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <div
                                ...
                                <span class="avatar me-sm-4 my-auto">
                                    <span class="avatar-initial bg-label-secondary rounded"><img
                                            src="assets/svg/icons/checks.svg" class="sidebar-svg-icon"
                                            style="width: 25px" /></span>
                                </span>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            ...
                            <div
                                ...
                                <span class="avatar me-sm-4 my-auto">
                                    <span class="avatar-initial bg-label-secondary rounded"><img
                                            src="assets/svg/icons/cross.svg" class="sidebar-svg-icon"
                                            style="width: 25px" /></span>
                                </span>
                            </div>
                        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-flex justify-content-between align-items-center row py-3 gap-3 gap-md-0">
                    ...
                    <div class="col-md-6 product_stock"></div>
                </div>
            </div>
...
@endsection
@push('scripts')
<script src="assets/js/app-client-list.js"></script>
@endpush