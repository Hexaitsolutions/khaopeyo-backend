...
$(function () {
  ...
  if (dt_product_table.length) {
    var dt_products = dt_product_table.DataTable({
      ...
      dom:
          '<"card-header d-flex justify-content-between align-items-center border-top rounded-0 py-2"' +
          '<"me-auto"l>' +  // Length menu on the left
          '<"d-flex align-items-center"f B>' + // Buttons and search bar on the right
          '>t' +
          '<"row mx-2"' +
      ...
      buttons: [
        {
          extend: 'collection',
          className: 'btn btn-label-secondary dropdown-toggle ms-3 me-3',
